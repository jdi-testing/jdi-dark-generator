...
public class CodegenConfiguratorJDI {
    ...
    public ClientOptInput toClientOptInput() {
        ...
        JavaClientCodegenJDI javaClientCodegenJDI;
        if (cnfg instanceof JavaClientCodegenJDI) {
            javaClientCodegenJDI = (JavaClientCodegenJDI) cnfg;
        }
        else {
        ...
        javaClientCodegenJDI.setInputSpec(specContent);
        javaClientCodegenJDI.setInputURL(inputSpecURL);
        ...
        if (javaClientCodegenJDI.needsUnflattenedSpec()) {
            ...
            javaClientCodegenJDI.setUnflattenedOpenAPI(openAPIUnflattened);
        }
        if (isNotBlank(outputDir)) {
            javaClientCodegenJDI.setOutputDir(outputDir);
        }
        javaClientCodegenJDI.setSkipOverwrite(skipOverwrite);
        javaClientCodegenJDI.setIgnoreFilePathOverride(ignoreFileOverride);
        javaClientCodegenJDI.setRemoveOperationIdPrefix(removeOperationIdPrefix);
        
        javaClientCodegenJDI.instantiationTypes().putAll(instantiationTypes);
        javaClientCodegenJDI.typeMapping().putAll(typeMappings);
        javaClientCodegenJDI.importMapping().putAll(importMappings);
        javaClientCodegenJDI.languageSpecificPrimitives().addAll(languageSpecificPrimitives);
        javaClientCodegenJDI.reservedWordsMappings().putAll(reservedWordMappings);
        
        javaClientCodegenJDI.setLanguageArguments(codegenArguments);
        
        checkAndSetAdditionalProperty(serializationLibrary, serializationLibrary);
        ...
        checkAndSetAdditionalProperty(outputDir, JavaCodegenConstantsJDI.OUTPUT_FOLDER);
        
        checkAndSetAdditionalProperty(serializationLibrary, JavaCodegenConstantsJDI.SERIALIZATION_LIBRARY);
        
        checkAndSetAdditionalProperty(templateEngine, JavaCodegenConstantsJDI.TEMPLATE_ENGINE);
        
        javaClientCodegenJDI.additionalProperties().putAll(additionalProperties);
        
        input.config(javaClientCodegenJDI);
        return input;
    }
    
    //  @JsonAnySetter
    //  public CodegenConfiguratorJDI addDynamicProperty(String name, Object value) {
    ...
    private void checkAndSetAdditionalProperty(String property, Object valueToSet, String propertyKey) {
